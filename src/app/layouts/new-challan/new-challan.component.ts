...
export class NewChallanComponent implements OnInit {
   ...
   /* public myDatePickerOptions: IMyDpOptions = {
    ...
    ngOnInit() {
        this.longDistanceShot =  new FormControl('', Validators.required);
       this.challanForm = new FormGroup({
           longDistanceShot: this.longDistanceShot
        });
            ...
            if (this.challanFiles.length === 2) {
                ...
                const shortDistanceShot: ChallanFile = this.challanFiles[1];
                    ...
                    const challan = {
                        ...
                        'offenceDate': new Date(this.model.year, this.model.month, this.model.day ),
